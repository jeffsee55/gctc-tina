...
// HEY
/**
 * Get swagger from https://developers.strava.com/swagger/swagger.json
 *
 * Transform into Types at https://editor.swagger.io/#/
 *
 * Choose Generate Client -> Typescript Fetch
 */
  ...
  return {
    ...
    createActivity(
      ...
      if (type === null || type === undefined) {
        throw new RequiredError(
          "type",
          "Required parameter type was null or undefined when calling createActivity."
        );
      }
...
export const ActivitiesApiFp = function (configuration?: Configuration) {
  return {
    ...
    getCommentsByActivityId(
      ...
      const localVarFetchArgs = ActivitiesApiFetchParamCreator(
        configuration
      ).getCommentsByActivityId(id, page, perPage, options);
      return (
        fetch: FetchAPI = portableFetch,
        basePath: string = BASE_PATH
      ) => {
...
export const AthletesApiFp = function (configuration?: Configuration) {
  return {
    ...
    getLoggedInAthleteZones(
      ...
      const localVarFetchArgs = AthletesApiFetchParamCreator(
        configuration
      ).getLoggedInAthleteZones(options);
      return (
        fetch: FetchAPI = portableFetch,
        basePath: string = BASE_PATH
      ) => {
 ...
 * @export
 */
export const RunningRacesApiFetchParamCreator = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    getRunningRaceById(id: number, options: any = {}): FetchArgs {
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling getRunningRaceById."
        );
      }
      const localVarPath = `/running_races/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      const localVarUrlObj = url.parse(localVarPath, true);
...
export const RunningRacesApiFp = function (configuration?: Configuration) {
  return {
    ...
    getRunningRaceById(
      id: number,
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<RunningRace> {
      const localVarFetchArgs = RunningRacesApiFetchParamCreator(
        configuration
      ).getRunningRaceById(id, options);
      return (
        fetch: FetchAPI = portableFetch,
        basePath: string = BASE_PATH
      ) => {
    ...
    getRunningRaces(
      year?: number,
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<Array<RunningRace>> {
      const localVarFetchArgs = RunningRacesApiFetchParamCreator(
        configuration
      ).getRunningRaces(year, options);
      return (
        fetch: FetchAPI = portableFetch,
        basePath: string = BASE_PATH
      ) => {
 ...
 * @export
 */
export const RunningRacesApiFactory = function (
  configuration?: Configuration,
  fetch?: FetchAPI,
  basePath?: string
) {
  return {
    ...
    getRunningRaceById(id: number, options?: any) {
      return RunningRacesApiFp(configuration).getRunningRaceById(id, options)(
        fetch,
        basePath
      );
    },
    ...
    getRunningRaces(year?: number, options?: any) {
      return RunningRacesApiFp(configuration).getRunningRaces(year, options)(
        fetch,
        basePath
      );
    },
...
export class RunningRacesApi extends BaseAPI {
  ...
  public getRunningRaceById(id: number, options?: any) {
    return RunningRacesApiFp(this.configuration).getRunningRaceById(
      id,
      options
    )(this.fetch, this.basePath);
  }
  ...
  public getRunningRaces(year?: number, options?: any) {
    return RunningRacesApiFp(this.configuration).getRunningRaces(year, options)(
      this.fetch,
      this.basePath
    );
  }

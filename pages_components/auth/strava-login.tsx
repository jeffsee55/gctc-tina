...
const oauthPage = `https://www.strava.com/oauth/authorize?client_id=51600&response_type=code&redirect_uri=http://localhost:2999/auth/strava-approval&approval_prompt=force&scope=${scopes.join(
  ","
)}`;

...
export const staticPaths = async (params) => {
  return {
    paths: [
      {
        params: { member: "jen" },
...
const CoachingForm = (props: AuthorDataType["form"]["data"]) => {
...
const Hero = (props: AuthorDataType) => {
  return (
...
const Stats = (props: AuthorDataType) => {
  return (
    <div
...
const Story = (props: AuthorDataType) => {
  return (
...
const Ebook = (props: AuthorDataType["ebook"]) => {
  return (
    <div className="bg-white">
